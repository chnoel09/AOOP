...
public class EmployeeDatabaseRepository implements EmployeeRepository {
    ...
    public void addEmployee(Employee employee) {
        ...
        try (Connection conn = DatabaseConnection.connect();
            ...
            stmt.setString(10, employee.getImmediateSupervisor());
            stmt.setDouble(11, employee.getBasicSalary());
            stmt.setDouble(12, employee.getRiceSubsidy());
            stmt.setDouble(13, employee.getPhoneAllowance());
            stmt.setDouble(14, employee.getClothingAllowance());
            stmt.setDouble(15, employee.getGrossSemiMonthlyRate());
            stmt.setDouble(16, employee.getHourlyRate());
            stmt.setString(17, employee.getSssNumber());
            stmt.setString(18, employee.getPhilhealthNumber());
            stmt.setString(19, employee.getTinNumber());
            stmt.setString(20, employee.getPagibigNumber());
            stmt.setString(21, employee.getUsername());
            stmt.setString(22, employee.getPassword());
            stmt.setString(23, employee.getRole());
